...
public class GatewayConstants {
	...
	public static final String USER_NOT_AVAIL = "User Not Available";

	public static final String USER_NOT_FOUND = "User not found";

	public static final String FORGOT_PASS_LINK = "Your Password has been reset and sent to your registered email id";
	...
	public static final String USER_BLOCKED = "Invalid password,Sorry your account has been locked.Kindly contact the admin";
